...
class MainWindow(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.worldCheck.stateChanged.connect(self.showWorldWidget)
    ...
    def showWorldWidget(self,state):
        if state == QtCore.Qt.Checked:
            print 'world checked'
        else:
            print 'world unchecked'  
            
    def closeWorldWidget(self):
        self.worldCheck.setChecked(False)   
