...
#ifndef __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_sonars_h__
#define __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_sonars_h__
...
public:
    ...
    ::IceInternal::ProxyHandle<SonarsData> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<SonarsData*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<Sonars> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Sonars*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
#else
static auto _SonarsData_init = ::jderobot::SonarsData::ice_factory;
#endif
