...
#ifndef __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_kinectleds_h__
#define __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_kinectleds_h__
...
public:
    ...
    void setLedActive(::jderobot::KinectLedsAvailable __p_led)
    {
        setLedActive(__p_led, 0);
    }
    void setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::Ice::Context& __ctx)
    {
        setLedActive(__p_led, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setLedActive(__p_led, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setLedActive(__p_led, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setLedActive(__p_led, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setLedActive(__p_led, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_setLedActive(::jderobot::KinectLedsAvailable __p_led)
    {
        return begin_setLedActive(__p_led, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::Ice::Context& __ctx)
    {
        return begin_setLedActive(__p_led, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setLedActive(__p_led, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setLedActive(__p_led, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::jderobot::Callback_KinectLeds_setLedActivePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setLedActive(__p_led, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setLedActive(::jderobot::KinectLedsAvailable __p_led, const ::Ice::Context& __ctx, const ::jderobot::Callback_KinectLeds_setLedActivePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setLedActive(__p_led, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<KinectLeds> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<KinectLeds*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
