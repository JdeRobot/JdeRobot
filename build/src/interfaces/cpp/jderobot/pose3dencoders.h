...
#ifndef __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_pose3dencoders_h__
#define __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_pose3dencoders_h__
...
public:
    ...
    ::IceInternal::ProxyHandle<Pose3DEncodersData> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Pose3DEncodersData*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<Pose3DEncoders> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Pose3DEncoders*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
#else
static auto _Pose3DEncodersData_init = ::jderobot::Pose3DEncodersData::ice_factory;
#endif
