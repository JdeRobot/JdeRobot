...
#ifndef __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_exceptions_h__
#define __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_exceptions_h__
