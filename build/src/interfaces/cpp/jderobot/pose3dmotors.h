...
#ifndef __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_pose3dmotors_h__
#define __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_pose3dmotors_h__
...
public:
    ...
    ::IceInternal::ProxyHandle<Pose3DMotorsData> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Pose3DMotorsData*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<Pose3DMotorsParams> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Pose3DMotorsParams*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
public:
    ...
    ::Ice::Int setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data)
    {
        return setPose3DMotorsData(__p_data, 0);
    }
    ::Ice::Int setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::Context& __ctx)
    {
        return setPose3DMotorsData(__p_data, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_setPose3DMotorsData(__p_data, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setPose3DMotorsData(__p_data, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_setPose3DMotorsData(__p_data, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setPose3DMotorsData(__p_data, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data)
    {
        return begin_setPose3DMotorsData(__p_data, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::Context& __ctx)
    {
        return begin_setPose3DMotorsData(__p_data, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPose3DMotorsData(__p_data, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPose3DMotorsData(__p_data, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::jderobot::Callback_Pose3DMotors_setPose3DMotorsDataPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPose3DMotorsData(__p_data, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setPose3DMotorsData(const ::jderobot::Pose3DMotorsDataPtr& __p_data, const ::Ice::Context& __ctx, const ::jderobot::Callback_Pose3DMotors_setPose3DMotorsDataPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPose3DMotorsData(__p_data, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<Pose3DMotors> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Pose3DMotors*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
#else
static auto _Pose3DMotorsData_init = ::jderobot::Pose3DMotorsData::ice_factory;
#endif
