...
#ifndef __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_pointcloud_h__
#define __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_pointcloud_h__
...
public:
    ...
    ::IceInternal::ProxyHandle<pointCloudData> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<pointCloudData*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<pointCloud> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<pointCloud*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
#else
static auto _pointCloudData_init = ::jderobot::pointCloudData::ice_factory;
#endif
