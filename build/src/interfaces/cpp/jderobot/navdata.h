...
#ifndef __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_navdata_h__
#define __jderobot__home_fran_fqez_build_src_interfaces_cpp_jderobot_navdata_h__
...
public:
    ...
    ::IceInternal::ProxyHandle<NavdataData> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<NavdataData*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<Navdata> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Navdata*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
#else
static auto _NavdataData_init = ::jderobot::NavdataData::ice_factory;
#endif
