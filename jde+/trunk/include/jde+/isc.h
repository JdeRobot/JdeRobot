...
public:
  ...
  */
  ...
  /**
     ...
     \exception std::logic_error if dest sid is unknown
     \exception std::runtime_error can't locate instance info (can't
     get schema factory suitable for this instance)
  */
