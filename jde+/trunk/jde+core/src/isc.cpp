...
/*isc definitions*/
Isc::Isc(Hierarchy* owner, bool debugflag)
  : debug(debugflag) {
...
void Isc::process(Pointer<Perception> p) {
  /*deliver it*/
...
void Isc::process(Pointer<Modulation> m) {
  /*deliver it*/
  Pointer<Schemainstance> dst_i;
  std::vector<Message_Processor*>::iterator p_it;
...
void Isc::process(Pointer<Arbitrate_Req> a) {
  /*deliver it*/
  Pointer<Schemainstance> dst_i;
  std::vector<Message_Processor*>::iterator p_it;
...
void Isc::process(Pointer<State_Change> s) {
  /*deliver it*/
  Pointer<Schemainstance> dst_i;
  std::vector<Message_Processor*>::iterator p_it;
...
void Isc::process(Pointer<New_State> n) {
  /*deliver it*/
  Pointer<Schemainstance> dst_i;
  std::vector<Message_Processor*>::iterator p_it;
...
void Isc::append_processor(Message_Processor* mp){
