...
public:
  ...
  class Instanceinfo {
  public:
    typedef std::map<sid_t,std::string> sid2nick_map_t;
    ...
    */
    ...
    /*
      ...
      \exception std::logic_error if instance hasn't got this child
    */
    sid_t get_child_sid(const std::string child_nick) const throw(std::logic_error);
    ...
    */
    ...
    /**
       ...
       \return true if sid identify a child of mine
    */
    bool is_child(const std::string child_nick) const throw();
