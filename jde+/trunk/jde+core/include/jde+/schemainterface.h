...
public:
  ...
  /**
     Constructor.
  */
  Schemainterface(const schema_type_enum type, const std::string& name, 
		  const std::string& nick) throw()
    :type(type),interface_name(name),nickname(nick) {}
  /**
     Destructor.
  */
...
public:
  Pschema(const std::string& name, const std::string& nick) throw()
    :Schemainterface(PSCHEMA,name,nick) {}
}
;
...
public:
  Mschema(const std::string& name, const std::string& nick) throw()
    :Schemainterface(MSCHEMA,name,nick) {}
}
;
